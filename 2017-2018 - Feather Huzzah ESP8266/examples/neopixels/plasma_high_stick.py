...
# 2017_1005 PePo Huzzah demo NeoPixels: matrix 8*8 on GPIO15, stick 1x8 on GPIO13
...
#''' 2017_1005 Huzzah Neopixel stick: 1 * 8 pixels, GPIO13
PIXEL_WIDTH = 1
PIXEL_HEIGHT = 8
PIXEL_PIN = 13
#'''

''' 2017_1005 Huzzah Feather Neopixel matrix: 8 * 8 pixels, GPIO15
PIXEL_WIDTH = 8
PIXEL_HEIGHT = 8
PIXEL_PIN = 15
#'''
...
MAX_BRIGHT = 255 #50  # 100

# create a neopixel array
#DEPRECATED: np = neopixel.NeoPixel(machine.Pin(13), PIXEL_WIDTH * PIXEL_HEIGHT)
np = neopixel.NeoPixel(machine.Pin(PIXEL_PIN, machine.Pin.OUT), PIXEL_WIDTH * PIXEL_HEIGHT)
